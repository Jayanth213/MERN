...
function GetMember() {
    ...
    const deleteUser = async (memberId) => {
        try {
            await axios.delete(API_URL +`api/   users/deleteuser/${memberId}`, { data: { memberId: memberId, isAdmin: memberDetails.isAdmin } });
                    ...
                    <div className="user-details-specific">
                        ...
                        <div className="specific-right">
                            ...
                            <div style={{ display: "flex", flexDirection: "column", flex: "0.5" }}>
                                ...
                                <p style={{ fontSize: "18px", display: "flex", alignItems: "center", justifyContent: "center" }}><b>Points</b></p>
                            ...
                            <button className='delete-button' onClick={() => deleteUser(memberDetails._id)}>Delete Account</button>
                        </div>
                    </div>
                </div>
